...
ACLOCAL = ${SHELL} /c/stuff/ode/missing --run aclocal-1.8
ALLOCA = 
AMDEP_FALSE = #
AMDEP_TRUE = 
AMTAR = ${SHELL} /c/stuff/ode/missing --run tar
AR = ar
AS = as
AUTOCONF = ${SHELL} /c/stuff/ode/missing --run autoconf
AUTOHEADER = ${SHELL} /c/stuff/ode/missing --run autoheader
AUTOMAKE = ${SHELL} /c/stuff/ode/missing --run automake-1.8
AWK = gawk
CC = gcc
...
LDFLAGS = 
LIBOBJS =  obstack$U.o
LIBS =  -lcomctl32 -lkernel32 -luser32 -lgdi32 -lstdc++ -lm
LIBTOOL = $(SHELL) $(top_builddir)/libtool
LIBTOOL_DEPS = ./ltmain.sh
LN_S = ln -s
LTLIBOBJS =  obstack$U.lo
MAKEINFO = ${SHELL} /c/stuff/ode/missing --run makeinfo
OBJDUMP = objdump
OBJEXT = o
ODE_AGE = 0
ODE_CURRENT = 0
...
infodir = ${prefix}/info
install_sh = /c/stuff/ode/install-sh
