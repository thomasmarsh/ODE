...
// // =============================================================================
// //
// // Testint the Hinge2 Joint
// //
// // =============================================================================
// // =============================================================================
// SUITE(JointHinge2)
// {
// TEST(test_hinge2GetInfo1)
// {
//   //       ^Y
//   //     |---|                             HiStop
//   //     |   |                     ^Y         /
...
//   dBodyID bId1 = dBodyCreate(wId);
//   dBodySetPosition(bId1, 0, -1, 0);

//   dBodyID bId2 = dBodyCreate(wId);
//   dBodySetPosition(bId2, 0, 1, 0);


//   dJointID jId = dJointCreateHinge2(wId, 0);
...
//   joint->vtable->getInfo1(jId, &info);
...
//                   dJointGetPRParam(jId, dParamStopERP) );
//     }
