...
ifeq ($(CONFIG),ReleaseDLL)
  ...
  OBJDIR := obj/feedback/ReleaseDLL
...
ifeq ($(CONFIG),ReleaseLib)
  ...
  OBJDIR := obj/feedback/ReleaseLib
...
clean:
	@echo Cleaning test_feedback
	-@rm -rf $(OUTDIR)/$(TARGET) $(OBJDIR)

$(OBJDIR)/test_feedback.o: ../../ode/test/test_feedback.cpp
	-@$(CMD_MKOBJDIR)
	@echo $(notdir $<)
	@$(CXX) $(CXXFLAGS) -o $@ -c $<
