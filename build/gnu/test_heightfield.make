...
ifeq ($(CONFIG),DebugDLL)
  BINDIR := ../../lib/DebugDLL
  LIBDIR := ../../lib/DebugDLL
  OBJDIR := obj/heightfield/DebugDLL
  OUTDIR := ../../lib/DebugDLL
...
ifeq ($(CONFIG),ReleaseDLL)
  ...
  OBJDIR := obj/heightfield/ReleaseDLL
...
ifeq ($(CONFIG),DebugLib)
  BINDIR := ../../lib/DebugLib
  LIBDIR := ../../lib/DebugLib
  OBJDIR := obj/heightfield/DebugLib
  OUTDIR := ../../lib/DebugLib
  CPPFLAGS := -MD -D "_CRT_SECURE_NO_DEPRECATE" -D "WIN32" -I "../../include"
  CFLAGS += $(CPPFLAGS) -g
  CXXFLAGS := $(CFLAGS)
...
ifeq ($(CONFIG),ReleaseLib)
  ...
  OBJDIR := obj/heightfield/ReleaseLib
...
clean:
	@echo Cleaning test_heightfield
	-@rm -rf $(OUTDIR)/$(TARGET) $(OBJDIR)

$(OBJDIR)/test_heightfield.o: ../../ode/test/test_heightfield.cpp
	-@$(CMD_MKOBJDIR)
	@echo $(notdir $<)
	@$(CXX) $(CXXFLAGS) -o $@ -c $<
