...
ifeq ($(CONFIG),DebugDLL)
  ...
  TARGET := test_moving_trimesh.exe
...
$(OUTDIR)/$(TARGET): $(OBJECTS) $(LDDEPS) $(RESOURCES)
	@echo Linking test_moving_trimesh
	-@$(CMD_MKBINDIR)
	-@$(CMD_MKLIBDIR)
	-@$(CMD_MKOUTDIR)
	@$(BLDCMD)
...
clean:
	@echo Cleaning test_moving_trimesh
	-@rm -rf $(OUTDIR)/$(TARGET) $(OBJDIR)

$(OBJDIR)/test_moving_trimesh.o: ../../ode/test/test_moving_trimesh.cpp
	-@$(CMD_MKOBJDIR)
	@echo $(notdir $<)
	@$(CXX) $(CXXFLAGS) -o $@ -c $<
