...
ifeq ($(CONFIG),DebugDLL)
  BINDIR := ../../lib/DebugDLL
  LIBDIR := ../../lib/DebugDLL
  OBJDIR := obj/cylvssphere/DebugDLL
  OUTDIR := ../../lib/DebugDLL
...
ifeq ($(CONFIG),ReleaseDLL)
  ...
  OBJDIR := obj/cylvssphere/ReleaseDLL
...
ifeq ($(CONFIG),DebugLib)
  BINDIR := ../../lib/DebugLib
  LIBDIR := ../../lib/DebugLib
  OBJDIR := obj/cylvssphere/DebugLib
  OUTDIR := ../../lib/DebugLib
  CPPFLAGS := -MD -D "_CRT_SECURE_NO_DEPRECATE" -D "WIN32" -I "../../include"
  CFLAGS += $(CPPFLAGS) -g
  CXXFLAGS := $(CFLAGS)
...
ifeq ($(CONFIG),ReleaseLib)
  ...
  OBJDIR := obj/cylvssphere/ReleaseLib
...
clean:
	@echo Cleaning test_cylvssphere
	-@rm -rf $(OUTDIR)/$(TARGET) $(OBJDIR)

$(OBJDIR)/test_cylvssphere.o: ../../ode/test/test_cylvssphere.cpp
	-@$(CMD_MKOBJDIR)
	@echo $(notdir $<)
	@$(CXX) $(CXXFLAGS) -o $@ -c $<
