...
ifeq ($(CONFIG),DebugDLL)
  ...
  OUTDIR := ../../lib/DebugDLL
  CPPFLAGS := -MMD -D "HAVE_CONFIG_H" -D "WIN32" -D "ODE_DLL" -I "../.." -I "../../include" -I "../../OPCODE" -I "../../GIMPACT/include"
  CFLAGS += $(CPPFLAGS) $(TARGET_ARCH) -g
  CXXFLAGS := $(CFLAGS)
  LDFLAGS += -L$(BINDIR) -L$(LIBDIR) -shared -Wl,--out-implib="../../lib/DebugDLL/liboded.a" -luser32
  LDDEPS :=
  RESFLAGS := -D "HAVE_CONFIG_H" -D "WIN32" -D "ODE_DLL" -I "../.." -I "../../include" -I "../../OPCODE" -I "../../GIMPACT/include"
  TARGET := oded.dll
...
ifeq ($(CONFIG),DebugLib)
  ...
  OUTDIR := ../../lib/DebugLib
  CPPFLAGS := -MMD -D "HAVE_CONFIG_H" -D "WIN32" -D "ODE_LIB" -I "../.." -I "../../include" -I "../../OPCODE" -I "../../GIMPACT/include"
  CFLAGS += $(CPPFLAGS) $(TARGET_ARCH) -g
  CXXFLAGS := $(CFLAGS)
  LDFLAGS += -L$(BINDIR) -L$(LIBDIR) -luser32
  LDDEPS :=
  RESFLAGS := -D "HAVE_CONFIG_H" -D "WIN32" -D "ODE_LIB" -I "../.." -I "../../include" -I "../../OPCODE" -I "../../GIMPACT/include"
  TARGET := liboded.a
